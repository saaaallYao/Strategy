...
from pairs_strategy.core import StrategyConfig, build_spreads, compute_betas, generate_positions, volatility_target
...
class PairsSignalEngine:
    ...
    def compute_state(self, prices: pd.DataFrame) -> LiveStrategyState:
        ...
        split_ts = pd.Timestamp(self.cfg.train_split)
