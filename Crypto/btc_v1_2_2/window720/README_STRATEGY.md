# Fee-Aware BTC-ETH Strategy (Window=720)

This folder is a self-contained copy of the strategy package for running
BTC/ETH stat-arb with fee-aware logic and the window=720 parameters.
...
- Parameters were selected using the full period in `crypto_data.zip`:
  - 2023-08-01 -> 2025-08-02
- Subsequent sweeps on the most recent 12 months showed window=360 was stronger.
  This folder keeps the original window=720 baseline configuration.
